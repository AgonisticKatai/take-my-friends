...
const SuggestionsHome = () => {
  return (
    <Grid className='SuggestionsContent'>
      <Row className='SuggestionsContent'>
        <Col xs={2} md={1} className='glyphicon-align'>
          <Glyphicon className='glyphicon-hover' glyph='glyphicon glyphicon-chevron-left' />
        </Col>
        <Col xs={4} md={2}>
        ...
        <Col xs={2} md={1} className='glyphicon-align'>
          <Glyphicon className='glyphicon-hover' glyph='glyphicon glyphicon-chevron-right' />
        </Col>
      </Row>
    </Grid>
  )
